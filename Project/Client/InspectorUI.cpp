	...
	, m_arrResUI{}
{
	...
	m_arrComUI[(UINT)COMPONENT_TYPE::TRANSFORM]->SetSize(0.f, 200.f);	
	...
	m_arrComUI[(UINT)COMPONENT_TYPE::CAMERA]->SetSize(0.f, 550.f);
	...
	m_arrComUI[(UINT)COMPONENT_TYPE::LIGHT3D]->SetSize(0.f, 250.f);
	...
	m_arrComUI[(UINT)COMPONENT_TYPE::PARTICLESYSTEM]->SetSize(0.f, 450.f);
	...
	m_arrComUI[(UINT)COMPONENT_TYPE::FONT] = new FontUI;
	m_arrComUI[(UINT)COMPONENT_TYPE::FONT]->SetSize(0.f, 150.f);
	AddChildUI(m_arrComUI[(UINT)COMPONENT_TYPE::FONT]);
