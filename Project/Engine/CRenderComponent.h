...
private:
    ...
    bool                    m_bDynamicShadow;       // 그림자
    bool                    m_bShowDebugShape;      // FrustumCheck
    bool                    m_bShowCameraDebug;     // 카메라 절두체 표시 유무
    float                   m_CameraDebugScale;     // 카메라 절두체 크기
...
public:
    ...
    bool IsUseShowDebugShape() { return m_bShowDebugShape; }
