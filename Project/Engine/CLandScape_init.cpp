...
void CLandScape::CreateComputeShader()
{
	...
	if (nullptr == m_pHeightMap)
	{
		...
		if (nullptr == CResMgr::GetInst()->FindRes<CComputeShader>(L"HeightMapShader"))
			CResMgr::GetInst()->AddRes<CComputeShader>(L"HeightMapShader", m_pCSHeightMap.Get());
		else
			CResMgr::GetInst()->FindRes<CComputeShader>(L"HeightMapShader");
	}
	...
	if (nullptr == m_pCSRaycast)
	{
		...
		if (nullptr == CResMgr::GetInst()->FindRes<CComputeShader>(L"RaycastShader"))
			CResMgr::GetInst()->AddRes<CComputeShader>(L"RaycastShader", m_pCSHeightMap.Get());
		else
			CResMgr::GetInst()->FindRes<CComputeShader>(L"RaycastShader");
	}
	...
	if (nullptr == m_pCSWeightMap)
	{
		...
		if (nullptr == CResMgr::GetInst()->FindRes<CComputeShader>(L"WeightMapShader"))
			CResMgr::GetInst()->AddRes<CComputeShader>(L"WeightMapShader", m_pCSWeightMap.Get());
		else
			CResMgr::GetInst()->FindRes<CComputeShader>(L"WeightMapShader");
	}
}
