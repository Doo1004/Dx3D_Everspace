...
public:
    ...
    bool IsLayerMask(int _iLayer) { return (m_iLayerMask & (1 << _iLayer)) != 0; }
    ...
    void ShowCameraDebug(bool _bShow) { m_bShowCamereDebug = _bShow; }
    bool IsUseCameraDebug() { return m_bShowCamereDebug; }
